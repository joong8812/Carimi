...
public class AnalysisController {
	...
	public String analysisAF(HttpServletRequest request, Model model) throws Exception {
		...
		System.out.println("컨트롤러 : " +a1);
		System.out.println("컨트롤러 : " +b1);
		System.out.println("컨트롤러 : " +c11);
		System.out.println("컨트롤러 : " +c12);
		System.out.println("컨트롤러 : " +c13);
		System.out.println("컨트롤러 : " +c14);
		System.out.println("컨트롤러 : " +c15);
		System.out.println("컨트롤러 : " +c16);
		...
		// 아래의 것들은 CARDinformList로부터 받아 온 것을 member를 통해 등록하여 analysisAF에서 사용 할 수 있게 해준다.
...
//		model.addAttribute("sel8",sel8);
		...
		System.out.println(" 여기는 analysis controller!!! list " + CARDinformList.get(0));
